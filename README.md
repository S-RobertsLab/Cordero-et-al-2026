...
# Project Title: Code from Cordero et al. 2026

## Overview
This repository contains the code from the study by Cordero et al. (2026). The initial commit includes the raw code, and ongoing efforts are being made to clean it up for better readability and usability.
...
1. **Clone the repository**:
    ```sh
    git clone https://github.com/S-RobertsLab/Cordero-et-al-2026.git
    cd Cordero-et-al-2026
    ```
